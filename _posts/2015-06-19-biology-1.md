...
Google Chrome design team copied this pattern in time of the threaded[^threads]  browsers, and it paid off. In fact it goes even farther with the *[zygote][zygote-chrome]* process.
